...
bool DepthSource::setup(DeviceController& deviceController, bool bUseONIThread )
{
...
void DepthSource::onNewFrame(VideoStream& stream)
{
	...
	if (status != STATUS_OK)
	{
        ...
        updateFrame( videoFrameRef );
    }
}

void DepthSource::updateFrame( VideoFrameRef & videoFrameRef ){
